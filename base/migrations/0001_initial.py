    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.DecimalField(blank=True, decimal_places=2, max_digits=7, verbose_name='Rating')),
                ('numReviews', models.IntegerField(blank=True, default=0, null=True, verbose_name='Number of Reviews')),
                ('price', models.DecimalField(blank=True, decimal_places=2, max_digits=7, verbose_name='Price')),
                ('countInStock', models.IntegerField(blank=True, default=0, null=True, verbose_name='Count in stock')),
